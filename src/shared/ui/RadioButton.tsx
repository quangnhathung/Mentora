      ...
      <BottomBorder rounded="rounded-2xl" className={twMerge(`border-custom-5`)}>
        ...
        >
          <Pressable className={`min-h-[--s-radio] justify-center`} onPress={onChoose}>
            <View className={`h-full flex-row items-center justify-between px-3 py-1.5`}>
              <View className={`flex-1 flex-row items-center gap-2 align-middle`}>
                ...
                <View className={`${iconUrl ? 'w-4/5' : 'w-full'}`}>{children}</View>
              </View>
