...
export const CyanButton = ({ title, onPress, disabled, loading, className, textStyle }: Props) => {
  return (
    <BottomBorder
      className={twMerge(
    ...
    >
      <TouchableOpacity
        className={twMerge(
          `items-center justify-center rounded-xl bg-cyan-400 px-4 py-3 ${disabled && `bg-opacity`} `
        )}
        onPress={onPress}
