...
function StageInProgressSvg({ width = 113, height = 76, ...props }: any) {
  return (
    <Svg
      width={width}
      height={height}
    ...
    >
      ...
      <Defs>
        ...
        >
          ...
          <Stop offset={0.475} stopColor={colors.primary.DEFAULT} />
          <Stop offset={1} stopColor={colors.primary.light} />
        </LinearGradient>
        <LinearGradient
...
export default StageInProgressSvg;
