...
const FallbackUI: React.FC<FallbackProps> = ({ error, resetErrorBoundary }) => (
  <View className={`flex-1 items-center justify-center`}>
    ...
    <Button className={`rounded-xl bg-primary`} label="Reset" onPress={resetErrorBoundary} />
  </View>
);

export function withErrorBoundary<P extends JSX.IntrinsicAttributes = JSX.IntrinsicAttributes>(
